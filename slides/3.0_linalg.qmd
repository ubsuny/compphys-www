...
![pasted-movie.png](../assets/04_linalg/pasted-movie.png){width="70%" fig-alt="A 3D plot of three intersecting planes (green, yellow, and gray) meeting along a common line (thick blue line through the origin) - illustrating the geometric solution of a 3-equation, 3-unknown linear system."}
...
:::
::: {.column width="45%"}
![matrix_transform.tiff](../assets/04_linalg/matrix_transform.png){width="100%" fig-alt="Hand-drawn joke: a 2x2 rotation matrix [cos90 sin90; -sin90 cos90] multiplying a vector (a1, a2), with the result written as a blurred/redacted expression - a sight gag about the answer being illegible."}
:::
::::
...
![matrix_transform.tiff](../assets/04_linalg/matrix_transform.png){width="70%" fig-alt="Hand-drawn joke: a 2x2 rotation matrix [cos90 sin90; -sin90 cos90] multiplying a vector (a1, a2), with the result written as a blurred/redacted expression - a sight gag about the answer being illegible."}
...
:::
::: {.column width="45%"}
![pasted-movie.png](../assets/04_linalg/slide07_image11.png){width="100%" fig-alt="Peanuts-style cartoon of a boy in a baseball cap and glove shouting 'AAUGH!' in frustration - a humorous reaction image."}
:::
::::
...
:::
::: {.column width="45%"}
![pasted-movie.png](../assets/04_linalg/slide13_image12.png){width="100%" fig-alt="Diagram titled 'Reduced Row-Echelon Form': a 4x4 augmented matrix on the left reduced via an arrow to its RREF on the right, with pivot 1s and eliminated 0s highlighted in blue and purple."}
:::
::::
...
![](../assets/04_linalg/slide14_pasted-movie.png){fig-alt="A sequence of four 3x4 augmented matrices connected by right-arrows, showing step-by-step Gaussian elimination of a 3-equation system from its original form down to reduced triangular form."}
...
![Screenshot 2025-11-04 at 8.57.53 PM.png](../assets/04_linalg/Screenshot-2025-11-04-at-8.57.53-PM.png){width="70%" fig-alt="Equation (2.1.1): a block-matrix identity showing a 4x4 matrix A multiplied by four block columns (coordinate vectors x0, x1, x2 and the identity block Y) equal to four block columns (b0, b1, b2 and the 4x4 identity matrix), using a square-cup symbol to denote horizontal block concatenation."}
...
![](../assets/04_linalg/slide36_droppedImage.png){fig-alt="Hand-drawn sketch of a wiggly curve fit through several data points with vertical error bars, axes labeled y versus x - illustrating a generalized chi-squared fit."}
...
![](../assets/04_linalg/slide39_image21.png){fig-alt="Decorative hand-painted blue rectangular border/frame; the image itself contains no other content."}
...
![](../assets/04_linalg/slide41_pasted-movie.png){fig-alt="Wheatstone bridge circuit diagram: a battery (+) connects to a diamond-shaped bridge of four resistors R1, R2 (variable, with an arrow indicating adjustability), R3, and Rx at corners A, B, C, D, with a galvanometer V_G bridging D and B."}
...
![](../assets/04_linalg/slide42_300px-Wheatstonebridge.svg.png){fig-alt="Simplified schematic of a Wheatstone bridge: a diamond arrangement of four resistors R1, R2, R3, Rx around corners A, B, C, D, with a galvanometer V_G connecting D and B, powered by a battery on the left."}
...
![](../assets/04_linalg/slide43_300px-Wheatstonebridge.svg.png){fig-alt="Simplified schematic of a Wheatstone bridge: a diamond arrangement of four resistors R1, R2, R3, Rx around corners A, B, C, D, with a galvanometer V_G connecting D and B, powered by a battery on the left."}
...
![](../assets/04_linalg/slide44_300px-Wheatstonebridge.svg.png){fig-alt="Simplified schematic of a Wheatstone bridge: a diamond arrangement of four resistors R1, R2, R3, Rx around corners A, B, C, D, with a galvanometer V_G connecting D and B, powered by a battery on the left."}
...
![](../assets/04_linalg/slide45_300px-Wheatstonebridge.svg.png){fig-alt="Simplified schematic of a Wheatstone bridge: a diamond arrangement of four resistors R1, R2, R3, Rx around corners A, B, C, D, with a galvanometer V_G connecting D and B, powered by a battery on the left."}
