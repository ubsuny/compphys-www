...
- Examples: [CompPhys/ReviewPython](https://github.com/ubsuny/CompPhys/tree/main/ReviewPython)

## Getting started

- You should have a working python environment via pixi. Try it out now:
...
- If this *doesn't* work, go back to the setup instructions.
...
- However, Python is slower than *cold molasses in winter*
...
- However, you should not be thinking "either/or". Instead, think "both/and"!
  - Use python for your human-facing code, and C++ for your hardcore numerical algorithms. 
  - Then, call C++ code from python, e.g. using swig.
  - This is what scipy/numpy/etc do!
...
```bash
test.cc:2:10: warning: implicit conversion from 'long' to 'int' changes value from 1000000000000000000 to -1486618624 [-Wconstant-conversion]
    2 |         int i = 1'000'000'000'000'000'000;
      |             ~   ^~~~~~~~~~~~~~~~~~~~~~~~~
1 warning generated.
```
:::
...
name = "Bob"
age = 32
s4 = name + " is " + str(age) + " years old"

s5 = f"{name} is {age} years old"

# Older method
s6 = "{} is {} years old".format(name, age)
```
...
std::string s5 = std::format("{} is {} years old", name, age);
...
```python
z1 = f(1.0, 2.0) # Regular/full specification
z2 = f(1.0) # y is default
z3 = f() # x and y are default
z4 = f(y=2.0, x=1.0) # Mixed order is allowed
z5 = f(y=2.0) # x is default
...
```cpp
double z1 = f(1.0, 2.0);
double z2 = f(1.0); // y is default
double z3 = f(); // x and y are default
// That's all, folks!
```
:::
::::

- In python, **keyword** arguments (the ones where you explicitly write the name) can be written in any order, or even omitted!
...
![pasted-movie.png](../assets/0.4_python/pasted-movie.png){width="70%" fig-alt="TODO: describe image"}
...
:::
::: {.column width="45%"}
![TODO: describe image](../assets/0.4_python/image1.png){width="100%" fig-alt="TODO: describe image"}
:::
::::
...
:::
::: {.column width="45%"}
![pasted-movie.png](../assets/0.4_python/slide32_image10.png){width="100%" fig-alt="TODO: describe image"}
:::
::::
...
:::
::: {.column width="45%"}
![pasted-movie.png](../assets/0.4_python/slide33_image10.png){width="100%" fig-alt="TODO: describe image"}
![pasted-movie.png](../assets/0.4_python/slide33_image11.png){width="100%" fig-alt="TODO: describe image"}
:::
::::
...
![pasted-movie.png](../assets/0.4_python/slide45_image12.png){width="70%" fig-alt="TODO: describe image"}
...
![](../assets/0.4_python/slide55_image2.png){fig-alt="TODO"}
...
![](../assets/0.4_python/slide58_image13.png){fig-alt="TODO"}
...
![](../assets/0.4_python/slide60_image3.png){fig-alt="TODO"}
...
![](../assets/0.4_python/slide61_Screenshot-2025-09-22-at-11.34.54-AM.png){fig-alt="TODO"}
...
![](../assets/0.4_python/slide64_image15.png){fig-alt="TODO"}

![](../assets/0.4_python/slide64_image16.png){fig-alt="TODO"}
...
:::
::: {.column width="45%"}
![Figure 5.png](../assets/0.4_python/Figure-5.png){width="100%" fig-alt="TODO: describe image"}
:::
::::
...
![](../assets/0.4_python/slide70_image4.png){fig-alt="TODO"}
...
![pasted-movie.png](../assets/0.4_python/cms-coordinates.png){width="70%" fig-alt="TODO: describe image"}

![Screenshot 2025-09-23 at 11.58.00 PM.png](../assets/0.4_python/Screenshot-2025-09-23-at-11.58.00-PM.png){width="70%" fig-alt="TODO: describe image"}
...
![](../assets/0.4_python/slide96_image22.png){fig-alt="TODO"}
...
![](../assets/0.4_python/slide99_image5.png){fig-alt="TODO"}
...
![](../assets/0.4_python/slide100_image5.png){fig-alt="TODO"}

![](../assets/0.4_python/slide100_image6.png){fig-alt="TODO"}

![](../assets/0.4_python/slide100_image7.png){fig-alt="TODO"}

![](../assets/0.4_python/slide100_image8.png){fig-alt="TODO"}
...
- =
![](../assets/0.4_python/slide101_image7.png){fig-alt="TODO"}

![](../assets/0.4_python/slide101_image5.png){fig-alt="TODO"}

![](../assets/0.4_python/slide101_image9.png){fig-alt="TODO"}

- =
![](../assets/0.4_python/slide101_image10.png){fig-alt="TODO"}
...
:::
::: {.column width="45%"}
![TODO: describe image](../assets/0.4_python/image11.png){width="100%" fig-alt="TODO: describe image"}
:::
::::
...
![TODO: describe image](../assets/0.4_python/image12.png){width="70%" fig-alt="TODO: describe image"}
...
![](../assets/0.4_python/slide104_image13.png){fig-alt="TODO"}

![](../assets/0.4_python/slide104_image14.png){fig-alt="TODO"}

- Memory

![](../assets/0.4_python/slide104_image15.png){fig-alt="TODO"}
...
![](../assets/0.4_python/slide106_pasted-movie.png){fig-alt="TODO"}

![](../assets/0.4_python/slide106_image26.png){fig-alt="TODO"}
...
![](../assets/0.4_python/slide112_image5.png){fig-alt="TODO"}
...
![](../assets/0.4_python/slide113_image5.png){fig-alt="TODO"}

![](../assets/0.4_python/slide113_image6.png){fig-alt="TODO"}

![](../assets/0.4_python/slide113_image7.png){fig-alt="TODO"}

![](../assets/0.4_python/slide113_image8.png){fig-alt="TODO"}
...
- =
![](../assets/0.4_python/slide114_image7.png){fig-alt="TODO"}

![](../assets/0.4_python/slide114_image5.png){fig-alt="TODO"}

![](../assets/0.4_python/slide114_image9.png){fig-alt="TODO"}

- =
![](../assets/0.4_python/slide114_image10.png){fig-alt="TODO"}
...
![](../assets/0.4_python/slide117_image13.png){fig-alt="TODO"}

![](../assets/0.4_python/slide117_image14.png){fig-alt="TODO"}

- Memory

![](../assets/0.4_python/slide117_image15.png){fig-alt="TODO"}
...
![pasted-movie.png](../assets/0.4_python/slide118_image29.png){width="70%" fig-alt="TODO: describe image"}
...
![](../assets/0.4_python/slide120_pasted-movie.png){fig-alt="TODO"}

![](../assets/0.4_python/slide120_image26.png){fig-alt="TODO"}
...
:::
::: {.column width="45%"}
![pasted-movie.png](../assets/0.4_python/slide126_image30.png){width="100%" fig-alt="TODO: describe image"}
:::
::::
...
![Screenshot 2025-09-26 at 11.21.45 AM.png](../assets/0.4_python/Screenshot-2025-09-26-at-11.21.45-AM.png){width="70%" fig-alt="TODO: describe image"}
...
![pasted-movie.png](../assets/0.4_python/slide145_image32.png){width="70%" fig-alt="TODO: describe image"}
...
![eingesetzter-Film.png](../assets/0.4_python/eingesetzter-Film.png){width="70%" fig-alt="TODO: describe image"}
