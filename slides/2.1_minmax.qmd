...
![](../assets/2.1_minmax/slide04_droppedImage.png){fig-alt="A bumpy curve between endpoints X1 and X2 with several labeled critical points (A through G): local maxima (A, C, G), local minima (B, D, F), and inflection-like points (E, X, Y, Z), illustrating the difference between local and global extrema."}
...
![](../assets/2.1_minmax/slide05_droppedImage.png){fig-alt="A bumpy curve between endpoints X1 and X2 with several labeled critical points (A through G): local maxima (A, C, G), local minima (B, D, F), and inflection-like points (E, X, Y, Z), illustrating the difference between local and global extrema."}
...
![](../assets/2.1_minmax/slide06_droppedImage.png){fig-alt="A bumpy curve between endpoints X1 and X2 with several labeled critical points (A through G): local maxima (A, C, G), local minima (B, D, F), and inflection-like points (E, X, Y, Z), illustrating the difference between local and global extrema."}

- Global minimum

- Local minima

![](../assets/2.1_minmax/slide06_pasted-movie.png){fig-alt="Photograph of a chalkboard sign in a shop window reading 'THANK YOU for shopping LOCAL' - a pun accompanying the discussion of local versus global extrema."}
...
![](../assets/2.1_minmax/slide09_droppedImage.png){fig-alt="A bumpy curve between endpoints X1 and X2 with several labeled critical points (A through G): local maxima (A, C, G), local minima (B, D, F), and inflection-like points (E, X, Y, Z), illustrating the difference between local and global extrema."}
...
![](../assets/2.1_minmax/slide11_Screenshot-2025-10-30-at-4.18.36-PM.png){fig-alt="Figure 10.2.1 (Numerical Recipes), 'Successive bracketing of a minimum': a curve initially bracketed by points 1, 3, 2; the function is evaluated at 4 (replacing 2), then 5 (replacing 1), then 6 (replacing 4), narrowing the bracket around the minimum to points 5, 3, 6."}
...
![](../assets/2.1_minmax/slide12_Screenshot-2025-10-30-at-4.18.36-PM.png){fig-alt="Figure 10.2.1 (Numerical Recipes), 'Successive bracketing of a minimum': a curve initially bracketed by points 1, 3, 2; the function is evaluated at 4 (replacing 2), then 5 (replacing 1), then 6 (replacing 4), narrowing the bracket around the minimum to points 5, 3, 6."}
...
![](../assets/2.1_minmax/slide13_Screenshot-2025-10-30-at-4.18.36-PM.png){fig-alt="Figure 10.2.1 (Numerical Recipes), 'Successive bracketing of a minimum': a curve initially bracketed by points 1, 3, 2; the function is evaluated at 4 (replacing 2), then 5 (replacing 1), then 6 (replacing 4), narrowing the bracket around the minimum to points 5, 3, 6."}
...
![](../assets/2.1_minmax/slide14_Screenshot-2025-10-30-at-4.18.36-PM.png){fig-alt="Figure 10.2.1 (Numerical Recipes), 'Successive bracketing of a minimum': a curve initially bracketed by points 1, 3, 2; the function is evaluated at 4 (replacing 2), then 5 (replacing 1), then 6 (replacing 4), narrowing the bracket around the minimum to points 5, 3, 6."}
...
![](../assets/2.1_minmax/slide15_Screenshot-2025-10-30-at-4.18.36-PM.png){fig-alt="Figure 10.2.1 (Numerical Recipes), 'Successive bracketing of a minimum': a curve initially bracketed by points 1, 3, 2; the function is evaluated at 4 (replacing 2), then 5 (replacing 1), then 6 (replacing 4), narrowing the bracket around the minimum to points 5, 3, 6."}
...
![](../assets/2.1_minmax/slide16_Screenshot-2025-10-30-at-4.18.36-PM.png){fig-alt="Figure 10.2.1 (Numerical Recipes), 'Successive bracketing of a minimum': a curve initially bracketed by points 1, 3, 2; the function is evaluated at 4 (replacing 2), then 5 (replacing 1), then 6 (replacing 4), narrowing the bracket around the minimum to points 5, 3, 6."}
...
![](../assets/2.1_minmax/slide17_Screenshot-2025-10-30-at-4.18.36-PM.png){fig-alt="Figure 10.2.1 (Numerical Recipes), 'Successive bracketing of a minimum': a curve initially bracketed by points 1, 3, 2; the function is evaluated at 4 (replacing 2), then 5 (replacing 1), then 6 (replacing 4), narrowing the bracket around the minimum to points 5, 3, 6."}
...
![](../assets/2.1_minmax/slide18_Screenshot-2025-10-30-at-4.18.36-PM.png){fig-alt="Figure 10.2.1 (Numerical Recipes), 'Successive bracketing of a minimum': a curve initially bracketed by points 1, 3, 2; the function is evaluated at 4 (replacing 2), then 5 (replacing 1), then 6 (replacing 4), narrowing the bracket around the minimum to points 5, 3, 6."}
...
![](../assets/2.1_minmax/slide19_Screenshot-2025-10-30-at-4.18.36-PM.png){fig-alt="Figure 10.2.1 (Numerical Recipes), 'Successive bracketing of a minimum': a curve initially bracketed by points 1, 3, 2; the function is evaluated at 4 (replacing 2), then 5 (replacing 1), then 6 (replacing 4), narrowing the bracket around the minimum to points 5, 3, 6."}
...
![](../assets/2.1_minmax/slide20_droppedImage.png){fig-alt="Hand-drawn sketch of a bowl-shaped curve with four vertical arrows labeled 1, 2, 3, 4 marking sample points from left to right, and the handwritten caption '2, 3, 4 works!' - indicating that points 2, 3, and 4 form a valid bracketing triple around the minimum."}
...
![](../assets/2.1_minmax/slide24_droppedImage.png){fig-alt="Hand-drawn sketch of a curve dipping from point a down to a minimum and back up to point b, with three points x, w, v marked near the minimum and small arrows labeling the spacings delta-x and delta-v between them."}
...
![](../assets/2.1_minmax/slide25_droppedImage.png){fig-alt="Hand-drawn sketch of a curve dipping from point a down to a minimum and back up to point b, with three points x, w, v marked near the minimum and small arrows labeling the spacings delta-x and delta-v between them."}
...
![](../assets/2.1_minmax/slide26_droppedImage.png){fig-alt="Hand-drawn sketch of a curve dipping from point a down to a minimum and back up to point b, with three points x, w, v marked near the minimum and small arrows labeling the spacings delta-x and delta-v between them."}
...
![](../assets/2.1_minmax/slide27_mexican-hat.png){fig-alt="3D 'Mexican hat' (sombrero) potential V(phi) plotted over the complex plane (Re(phi), Im(phi)): an unstable ball sits at the central peak while a second ball rolls down into the circular trough of minima - the classic symmetry-breaking potential shape."}
...
![](../assets/2.1_minmax/slide30_surface.png){fig-alt="3D surface plot of a bumpy, multi-modal function f(x,y) over x,y in [-1,1], colored orange-to-purple by height, with a contour plot of the same function projected onto the floor of the plot box - illustrating a rugged N-dimensional objective-function landscape with many local optima."}
...
![](../assets/2.1_minmax/slide36_350px-Gradient_descent.png){fig-alt="Blue elliptical contour lines of a 2D function around a central minimum, with a red arrow path from x0 through x1, x2, x3 to x4, zig-zagging inward toward the center - illustrating gradient descent's characteristic slow, zig-zagging convergence on an elongated (ill-conditioned) bowl."}
...
![](../assets/2.1_minmax/slide37_350px-Gradient_descent.png){fig-alt="Blue elliptical contour lines of a 2D function around a central minimum, with a red arrow path from x0 through x1, x2, x3 to x4, zig-zagging inward toward the center - illustrating gradient descent's characteristic slow, zig-zagging convergence on an elongated (ill-conditioned) bowl."}
...
![](../assets/2.1_minmax/slide43_700px-NaCl_polyhedra.png){fig-alt="3D rendering of the rock-salt (NaCl) crystal structure: green chloride and white/gray sodium ions arranged on a cubic lattice, with two octahedral ion-coordination polyhedra highlighted (one gray, one green) to show the local bonding geometry."}
...
![](../assets/2.1_minmax/slide45_nacl-clusters.png){fig-alt="A grid of 20 numbered small NaCl cluster structures (green/gray ion positions connected by blue bonds), showing equilibrium geometries of increasing cluster size - from simple 2-3 ion chains up to complex 3D cage-like clusters of dozens of ions."}
...
![](../assets/2.1_minmax/slide46_nacl-clusters.png){fig-alt="A grid of 20 numbered small NaCl cluster structures (green/gray ion positions connected by blue bonds), showing equilibrium geometries of increasing cluster size - from simple 2-3 ion chains up to complex 3D cage-like clusters of dozens of ions."}
